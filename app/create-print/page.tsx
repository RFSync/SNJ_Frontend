...
// Helper component to load and display a GLB model
...
export default function CreatePrint() {
	...
	const totalSteps = 4; // <-- Update to 4 steps
	...
	// Modal state for 3D model viewer
	...
	const simulateWebhook = () => {
		...
		if (typeof windowWithWebhook.receiveWebhook === "function") {
			windowWithWebhook.receiveWebhook({
				resultUrl: "https://example.com/your-awesome-figure.glb",
			});
		}
	};
		...
		<div className='min-h-screen bg-paper flex flex-col'>
			<div className='flex-1 flex flex-col'>
				...
				<div className=' py-2'>
					<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
						<div className='flex justify-between items-center relative'>
							{/* Connecting line */}
							<div className='absolute top-4 left-2 right-2 h-0.5 bg-gradient-to-r from-purple-300 to-pink-300 z-0'></div>
				...
				<div className='flex-1 relative overflow-hidden'>
					<div
						className=' inset-0 transition-transform duration-500 ease-in-out flex'
						style={{ transform: `translateX(-${currentStep * 100}%)` }}
					>
						{/* Step 1: Upload */}

						<div className='min-w-full h-full flex flex-col items-center justify-center p-4 pt-8 top-0'>
							<div className='max-w-2xl w-full bg-white/70 backdrop-blur-sm p-6 rounded-lg shadow-xl border-2 border-pink-300'>
									...
									<div className='flex flex-col'>
										<div
											className={`flex-1 border-2 border-dashed ${
												isDragging
													...
													: "border-purple-300"
											} rounded-lg p-6 text-center cursor-pointer hover:border-pink-500 transition-colors duration-200 flex flex-col items-center justify-center`}
										...
										>
											...
											<p className='text-sm text-purple-600 mb-3'>
												Supported formats: .STL, .OBJ, .3MF, and images
											</p>
									...
									<div className='flex flex-col '>
										{selectedFile ? (
											...
											<div className='w-full h-48 bg-gray-100 rounded-lg border-2 border-dashed border-purple-300 flex items-center justify-center'>
												<p className='text-purple-600 text-center px-4'>
													No file selected
												</p>
											</div>
										)}
								...
								<div className='flex flex-col mt-4 space-y-4'>
									{/* <div className='bg-purple-100 rounded-lg p-4 w-full'>
							...
							<div className='flex-1 flex flex-col items-center justify-center p-4 pt-8'>
								<div className='max-w-2xl w-full bg-white/70 backdrop-blur-sm p-6 rounded-lg shadow-xl border-2 border-cyan-300'>
									<div className='text-center mb-6'>
										...
										<p className='text-purple-800 mt-1'>
											We're preparing your model for printing
										</p>
									</div>
										...
										<div className='bg-purple-100 rounded-lg p-4'>
											...
											<ul className='text-purple-700 space-y-2'>
												<li className='flex items-center'>
													...
													<span>Uploading to mega awesome servers</span>
												</li>
												<li className='flex items-center'>
													{uploadComplete ? (
														soundComplete ? (
												...
												<li className='flex items-start'>
													...
													<div>
														<span>
															Transforming you into super awesome figure
														</span>
														{soundComplete && !transformComplete && (
															<p className='text-xs text-pink-500 mt-1'>
																This might take a bit, but it's worth it! 🚀
															</p>
														)}
													</div>
												</li>
									...
									{transformComplete && !webhookReceived && (
										<div className='mb-6 p-3 bg-yellow-100 border border-yellow-300 rounded-md'>
											<p className='text-yellow-800 text-sm'>
												<strong>Demo Note:</strong> In a real application, this
												step would complete when a webhook is received from the
												server. For demo purposes, you can simulate this by
						...
						<div className='min-w-full h-full flex flex-col items-center justify-center p-8'>
							<div className='max-w-2xl w-full bg-white/70 backdrop-blur-sm p-8 rounded-lg shadow-xl border-2 border-cyan-300'>
								<div className='text-center mb-8'>
									<CheckCircle className='h-16 w-16 text-purple-600 mx-auto mb-4' />
									<h2 className='text-3xl font-bold bg-gradient-to-r from-cyan-500 to-purple-600 text-transparent bg-clip-text'>
										Review Your Model
									</h2>
									<p className='text-purple-800 mt-2'>
										Preview your 3D model video before ordering.
									</p>
								</div>
								<div className='mb-8 flex flex-col items-center'>
									{resultUrl ? (
										<>
											<div className='w-full h-64 bg-gray-100 rounded-lg border-2 border-purple-300 flex items-center justify-center overflow-hidden'>
												<video
													src={resultUrl}
													controls
											...
											<a
												...
												className='mt-4 px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-500 text-white rounded-md shadow hover:from-purple-700 hover:to-pink-600'
											>
												Open in New Tab
											</a>
										</>
								...
								<div className='flex justify-between'>
									...
									<button
										onClick={nextStep}
										className='px-6 py-2 bg-gradient-to-r from-cyan-500 to-purple-600 text-white font-medium rounded-md shadow-md hover:from-cyan-600 hover:to-purple-700 transition-colors duration-200'
									>
										Continue
									</button>
								</div>
								...
								<div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-8'>
									...
									<div>
										...
										<div className='space-y-2 text-purple-700'>
											<p>
												<span className='font-medium'>Dimensions:</span> 10cm x
												8cm x 5cm
											</p>
											<p>
								...
								<div className='mb-8'>
									<label className='flex items-center space-x-2'>
										<input
											type='checkbox'
											id='termsCheckbox'
											className='w-5 h-5 text-purple-600 border-2 border-purple-300 rounded focus:ring-pink-500'
											required
										/>
